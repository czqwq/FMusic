...
public class VoteObj {
    ...
    public void init() {
        ...
        if (timeOut == null) timeOut = "<gold>[FMusic]<yellow>切歌时间结束";
        if (err1 == null) err1 = "<gold>[FMusic]<red>你没有发起切歌";
        if (err2 == null) err2 = "<gold>[FMusic]<red>你发起的切歌已超时";
        if (err3 == null) err3 = "<gold>[FMusic]<red>已经有人发起了切歌";
        if (voteDone == null) voteDone = "<gold>[FMusic]<yellow>已切歌";

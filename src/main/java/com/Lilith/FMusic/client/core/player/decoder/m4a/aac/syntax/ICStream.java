...
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.error.RVLC;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.gain.GainControl;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.huffman.HCB;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.huffman.Huffman;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.tools.TNS;
...
public class ICStream implements Constants, HCB, ScaleFactorTable, IQTable {
    ...
    public void decode(BitStream in, boolean commonWindow, DecoderConfig conf) throws AACException {
        ...
        final boolean er = conf.getProfile()

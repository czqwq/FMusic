package com.Lilith.FMusic.client.core.player.decoder.m4a;
...
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.Decoder;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.SampleBuffer;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.MP4Container;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.api.AudioTrack;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.api.Frame;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.api.Track;
...
public class M4ADecoder implements IDecoder {
    ...
    public M4ADecoder(InputStream stream) throws IOException {
        ...
        for (Track track : container.getMovie()
            .getTracks()) {

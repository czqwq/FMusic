...
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.BitRateBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ChapterBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ChunkOffsetBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.CleanApertureBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.CompositionTimeToSampleBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.CopyrightBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.DataEntryUrlBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.DataEntryUrnBox;
...
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.DegradationPriorityBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ESDBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.EditListBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.FileTypeBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.FreeSpaceBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.HandlerBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.HintMediaHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.IPMPControlBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.IPMPInfoBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ItemInformationBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ItemInformationEntry;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ItemLocationBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ItemProtectionBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.MediaDataBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.MediaHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.MetaBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.MetaBoxRelationBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.MovieExtendsHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.MovieFragmentHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.MovieFragmentRandomAccessOffsetBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.MovieHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ObjectDescriptorBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.OriginalFormatBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.PaddingBitBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.PixelAspectRatioBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.PrimaryItemBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ProgressiveDownloadInformationBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SampleDependencyBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SampleDependencyTypeBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SampleDescriptionBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SampleGroupDescriptionBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SampleScaleBox;
...
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SampleToGroupBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SchemeTypeBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.ShadowSyncSampleBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SoundMediaHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SubSampleInformationBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.SyncSampleBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.TrackExtendsBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.TrackFragmentHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.TrackFragmentRandomAccessBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.TrackFragmentRunBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.TrackHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.TrackReferenceBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.TrackSelectionBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.VideoMediaHeaderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.XMLBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.drm.FairPlayDataBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.fd.FDItemInformationBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.fd.FDSessionGroupBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.fd.FECReservoirBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.fd.FilePartitionBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.fd.GroupIDToNameBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.EncoderBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.GenreBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ID3TagBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ITunesMetadataBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ITunesMetadataMeanBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ITunesMetadataNameBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.NeroMetadataTagsBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.RatingBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.RequirementBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ThreeGPPAlbumBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ThreeGPPKeywordsBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ThreeGPPLocationBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ThreeGPPMetadataBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.meta.ThreeGPPRecordingYearBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.oma.OMAAccessUnitFormatBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.oma.OMACommonHeadersBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.oma.OMAContentIDBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.oma.OMAContentObjectBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.oma.OMADiscreteMediaHeadersBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.oma.OMARightsObjectBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.oma.OMATransactionTrackingBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.oma.OMAURLBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.AudioSampleEntry;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.FDHintSampleEntry;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.MPEGSampleEntry;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.RTPHintSampleEntry;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.TextMetadataSampleEntry;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.VideoSampleEntry;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.XMLMetadataSampleEntry;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.codec.AC3SpecificBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.codec.AMRSpecificBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.codec.AVCSpecificBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.codec.EAC3SpecificBox;
import com.Lilith.FMusic.client.core.player.decoder.m4a.mp4.boxes.impl.sampleentries.codec.EVRCSpecificBox;
...
public class BoxFactory implements BoxTypes {
    ...
    public static Box parseBox(Box parent, MP4InputStream in) throws IOException {
        ...
        if (parent != null) {
            ...
            if (size > parentLeft) throw new IOException(
                "error while decoding box '" + typeToString(type)
                    + "' at offset "
                    + offset
                    + ": box too large for parent");
        }

        Logger.getLogger("MP4 Boxes")
            .finest(typeToString(type));
        ...
        if (left > 0 && !(box instanceof MediaDataBox)
            && !(box instanceof UnknownBox)
            && !(box instanceof FreeSpaceBox))
            LOGGER.log(
                Level.INFO,
                "bytes left after reading box {0}: left: {1}, offset: {2}",
                new Object[] { typeToString(type), left, in.getOffset() });
        else if (left < 0) LOGGER.log(
            Level.SEVERE,
            "box {0} overread: {1} bytes, offset: {2}",
            new Object[] { typeToString(type), -left, in.getOffset() });
    ...
    private static BoxImpl forType(long type, long offset) {
        ...
        if (box == null) {
            LOGGER.log(
                Level.INFO,
                "BoxFactory: unknown box type: {0}; position: {1}",
                new Object[] { typeToString(type), offset });
            box = new UnknownBox();
        }
        return box;
    }

package com.Lilith.FMusic.client.core.player.decoder.m4a.aac.tools;

import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.huffman.HCB;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.syntax.CPE;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.syntax.Constants;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.syntax.ICSInfo;
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.syntax.ICStream;
...
public final class MS implements Constants, HCB {
    ...
    public static void process(CPE cpe, float[] specL, float[] specR) {
        ...
        final int[] sfbCBr = cpe.getRightChannel()
            .getSfbCB();
        int groupOff = 0;
        int g, i, w, j, idx = 0;

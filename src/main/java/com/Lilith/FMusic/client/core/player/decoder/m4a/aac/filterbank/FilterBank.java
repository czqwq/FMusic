package com.Lilith.FMusic.client.core.player.decoder.m4a.aac.filterbank;
...
import com.Lilith.FMusic.client.core.player.decoder.m4a.aac.syntax.ICSInfo.WindowSequence;
...
public class FilterBank implements Constants, SineWindows, KBDWindows {
        ...
        switch (windowSequence) {
            ...
            case EIGHT_SHORT_SEQUENCE:
                ...
                for (i = 0; i < shortLen; i++) {
                    ...
                    if (i < trans) out[mid + 4 * shortLen + i] = overlap[mid + shortLen * 4 + i]
    ...
    public void processLTP(WindowSequence windowSequence, int windowShape, int windowShapePrev, float[] in,
        float[] out) {
        int i;
